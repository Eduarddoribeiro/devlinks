export const listaProjetos = [
  {
    id: 1,
    titulo: "Blog Pessoal Fullstack",
    descricao: "Ecossistema completo com API REST em NestJS e Front-end em React. Implementa autenticação JWT, segurança com Bcrypt, e relacionamentos complexos entre usuários, postagens e temas em MySQL.",
...
},
  {
    ...
    descricao: "Aplicação web de clima consumindo a API Open-Meteo com interface responsiva e design adaptativo.",
    link: "https://github.com/Eduarddoribeiro/atmos-weather",
    tecnologias: ["HTML5", "CSS3", "JavaScript"]
  },
  {
    id: 5,
    titulo: "Sistema Bancário - POO",
    descricao: "Aplicação de console em TypeScript focada nos pilares da POO (Herança, Encapsulamento e Polimorfismo) para gerenciar operações de contas correntes e poupanças com regras de negócio específicas.",
    link: "https://github.com/Eduarddoribeiro/conta_bancaria",
